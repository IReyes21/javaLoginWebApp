...
{   
    ...
    public Optional<Customer> get(int id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // FIX: Populate the customer object from ResultSet
                customer.setID(rs.getInt("Customer_ID"));
                customer.setFirstName(rs.getString("Customer_First_Name"));
                customer.setLastName(rs.getString("Customer_Last_Name"));
                customer.setFavoriteMeal(rs.getString("Customer_Favorite_Meal"));
            }
            return Optional.ofNullable(customer);
        } catch (SQLException ex) {
            System.err.println(ex.toString());
            return Optional.empty(); // FIX: Return empty Optional instead of null
        }
    }
    ...
    public List<Customer> getAll() {
        ...
        try {
            ...
            System.err.println(ex.toString());
            return new ArrayList<>(); // FIX: Return empty list instead of null
        }
    }
    /**
